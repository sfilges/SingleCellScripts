...
cds_data <- '~/GitHub/SingleCellScripts/data/Rdata/cds_monocle2.Rdata'

# differentially expressed genes
gene_expression <- '~/GitHub/SingleCellScripts/data/gene_lists/monocle2_DEG_genes.csv'

# genes used for ordering
ordering_genes <- "~/GitHub/SingleCellScripts/data/gene_lists/ordering_genes.csv"
```
...
pdf(file = '~/GitHub/SingleCellScripts/figures/slingshot_trajectory.pdf', width = 9, height = 6)
...
pdf(file = '~/GitHub/SingleCellScripts/figures/scorpius_trajectory.pdf', width = 9, height = 6)
