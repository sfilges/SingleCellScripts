...
enrichment_plot <- function(data, id){
  ...
  kegg <- read.gmt(
    gmtfile = "~/GitHub/SingleCellScripts/data/MSigDB/c2.cp.kegg.v7.1.symbols.gmt"
  )
  cgp <- read.gmt(
    gmtfile = "~/GitHub/SingleCellScripts/data/MSigDB/c2.cgp.v7.1.symbols.gmt"
  )
  
  hgnc_symbols <- read.csv(
    file = "~/GitHub/SingleCellScripts/data/MSigDB/hgnc.txt",
    sep = '\t',
    header=TRUE
  )
...
ggplot2::ggsave(filename = '~/GitHub/SingleCellScripts/figures/enrichment_cluster_1.svg', plot = cluster_1, width = 9, height = 6, device = "svg")
ggplot2::ggsave(filename = '~/GitHub/SingleCellScripts/figures/enrichment_cluster_1.pdf', plot = cluster_1, width = 9, height = 6, device = "pdf")

# Save cluster1 enrichments
ggplot2::ggsave(filename = '~/GitHub/SingleCellScripts/figures/enrichment_cluster_2.svg', plot = cluster_2, width = 9, height = 6, device = "svg")
ggplot2::ggsave(filename = '~/GitHub/SingleCellScripts/figures/enrichment_cluster_2.pdf', plot = cluster_2, width = 9, height = 6, device = "pdf")

# Save cluster1 enrichments
ggplot2::ggsave(filename = '~/GitHub/SingleCellScripts/figures/enrichment_cluster_3.svg', plot = cluster_3, width = 9, height = 6, device = "svg")
ggplot2::ggsave(filename = '~/GitHub/SingleCellScripts/figures/enrichment_cluster_3.pdf', plot = cluster_3, width = 9, height = 6, device = "pdf")

# Save cluster1 enrichments
ggplot2::ggsave(filename = '~/GitHub/SingleCellScripts/figures/enrichment_cluster_4.svg', plot = cluster_4, width = 9, height = 6, device = "svg")
ggplot2::ggsave(filename = '~/GitHub/SingleCellScripts/figures/enrichment_cluster_4.pdf', plot = cluster_4, width = 9, height = 6, device = "pdf")
