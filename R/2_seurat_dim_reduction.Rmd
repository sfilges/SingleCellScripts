...
# Save umap1
ggplot2::ggsave(filename = paste(figures_dir, 'umap_samples.svg', sep = ''), plot = umap1, width = 9, height = 6, device = "svg")
ggplot2::ggsave(filename = paste(figures_dir, 'umap_samples.pdf', sep = ''), plot = umap1, width = 9, height = 6, device = "pdf")

# Save umap2
ggplot2::ggsave(filename = paste(figures_dir, 'umap_clusters.svg', sep = ''), plot = umap2, width = 9, height = 6, device = "svg")
ggplot2::ggsave(filename = paste(figures_dir, 'umap_clusters.pdf', sep = ''), plot = umap2, width = 9, height = 6, device = "pdf")

# Save umap3
ggplot2::ggsave(filename = paste(figures_dir, 'umap_cell_cycle.svg', sep = ''), plot = umap3, width = 9, height = 6, device = "svg")
ggplot2::ggsave(filename = paste(figures_dir, 'umap_cell_cycle.pdf', sep = ''), plot = umap3, width = 9, height = 6, device = "pdf")
